var rango = {desdeX: 0, hastaX: 961, desdeY: 0, hastaY: 577};
var Juego = {
  ...
  obstaculosCarretera: [
    ...
    new Obstaculo('imagenes/valla_horizontal.png', 70, 250, 30, 30, 1),
    new Obstaculo('imagenes/valla_horizontal.png', 100, 250, 30, 30, 1),
    ...
    new Obstaculo("imagenes/bache.png", 600, 100, 30, 30, 1),
    new Obstaculo("imagenes/bache.png", 800, 300, 30, 30, 1),
    new Obstaculo("imagenes/auto_verde_abajo.png", 870, 400, 15, 30, 1),
    new Obstaculo("imagenes/auto_verde_derecha.png", 240, 400, 30, 15, 1),
  ...
  enemigos: [
    new ZombieCaminante("imagenes/zombie1.png", 100, 100, 10, 10, 2, rango),
    new ZombieCaminante("imagenes/zombie1.png", 200, 200, 10, 10, 2, rango),
    new ZombieCaminante("imagenes/zombie1.png", 300, 300, 10, 10, 2, rango),
    new ZombieCaminante("imagenes/zombie1.png", 400, 400, 10, 10, 2, rango),
    new ZombieCaminante("imagenes/zombie1.png", 500, 500, 10, 10, 2, rango),
    new ZombieConductor("imagenes/tren_vertical.png", 644, 0, 30, 90, 5, rango, "v"),
    new ZombieConductor("imagenes/tren_vertical.png", 678, 961, 30, 90, 1, rango, "v"),
    new ZombieConductor("imagenes/tren_horizontal.png", 400, 322, 90, 30, 3, rango, "h"),
  ]
